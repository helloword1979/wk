      ...
      <!--   <th>留言分类</th>
		...
		<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
		 ...
		 <!-- <td><?php echo ($v["ma_otherinfo"]); ?></td>
          ...
          <td><a href="/admin.php/Home/Shop/ly_list_cl/id/<?php echo ($v["ma_id"]); ?>/" class="tablelink">回复处理</a>　<a href="/admin.php/Home/Shop/ly_list_del/id/<?php echo ($v["ma_id"]); ?>/" class="tablelink">删除</a></td>
