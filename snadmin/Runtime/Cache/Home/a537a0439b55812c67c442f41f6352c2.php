...
<body>
  ...
  <tr>
    <td> <form id="form1" name="form1" method="post" action="/admin.php/Home/Index/jywc">
  ...
  <tr>
    ...
    <td align="right">&nbsp;</td>
     ...
     <table class="tablelist">
		...
		<td><a href="/admin.php/Home/Index/jywcdel/id/<?php echo ($v["id"]); ?>" class="tablelink">删除</a></td>
