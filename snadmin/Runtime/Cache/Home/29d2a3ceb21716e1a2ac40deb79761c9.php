    ...
    <table class="tablelist">
      ...
      <td><?php echo ($ab=$v["ue_account"]); ?></td>
		  ...
		  <td><?php echo ($counts); echo (user_count($ab,$counts)); ?></td>
		   <td>
			 <?php if($v["ktghgl"] == '1'): ?><a href="/admin.php/Home/Index/ktghgl/user/<?php echo ($v["ue_account"]); ?>" class="tablelink">是</a><?php endif; ?> 
			<?php if($v["ktghgl"] == '2'): ?><a href="/admin.php/Home/Index/gbghgl/user/<?php echo ($v["ue_account"]); ?>" class="tablelink">否</a><?php endif; ?> 
		</td>
	   ...
	   <!--  <td><?php echo ($counts); echo (user_count($ab,$counts)); ?></td> -->
		...
		<td>  <a href="/admin.php/Home/Index/tgsy/user/<?php echo ($v["ue_account"]); ?>" class="tablelink">查看</a> </td>
		<td>  <a href="/admin.php/Home/Index/kcsy/user/<?php echo ($v["ue_account"]); ?>" class="tablelink">查看</a> </td>
       ...
       <!--  <td><?php echo (ipjc($v["ue_regip"])); ?> <a href="/admin.php/Home/Index/userlist/ip/<?php echo ($v["ue_regip"]); ?>">查看</a></td>
        ...
        <td><!-- <a href="/admin.php/Home/Index/team/user/<?php echo ($v["ue_account"]); ?>" class="tablelink">團隊</a> -->  <?php if($v["ue_status"] == '3'): ?><a href="/admin.php/Home/Index/jdhy/user/<?php echo ($v["ue_account"]); ?>" class="tablelink">已冻结</a><?php endif; ?> <?php if($v["ue_status"] != '3'): ?><a href="/admin.php/Home/Index/djhy/user/<?php echo ($v["ue_account"]); ?>" class="tablelink">冻结</a><?php endif; ?> <a href="/admin.php/Home/Index/user_xg/user/<?php echo ($v["ue_account"]); ?>" class="tablelink">修改</a> <a href="/admin.php/Home/Index/user_xx/user/<?php echo ($v["ue_account"]); ?>" class="tablelink">向下</a>     <!-- <a onClick="javascript:if(!confirm('确定删除此会员？'))  return  false; " href="/admin.php/Home/Index/userdel/id/<?php echo ($v["ue_id"]); ?>" >删除</a> -->   <!--  <a onClick="javascript:if(!confirm('确定重置保密？'))  return  false; " href="/admin.php/Home/Index/usermb/id/<?php echo ($v["ue_id"]); ?>" >重置保密</a> --> <a href="/index.php/Home/Login/loginadmin/account/<?php echo ($v["ue_account"]); ?>/password/<?php echo ($v["ue_password"]); ?>/secpw/<?php echo ($v["ue_secpwd"]); ?>" target="_blank">登入</a><!--<a href="/admin.php/Home/index/shenghe/account/<?php echo ($v["ue_account"]); ?>" target="_blank">审核</a>--></td>
