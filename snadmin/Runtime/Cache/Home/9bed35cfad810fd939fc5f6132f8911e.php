...
<body>
  ...
  <tr>
    <td> <form id="form1" name="form1" method="post" action="/admin.php/Home/Index/qiugou">
   ...
   <input name="user" type="text" class="dfinput" id="user" />
	<input name="" type="submit" class="btn" value="确认搜索"/>
	  ...
	  <td>
	   <form id="form1" name="form1" method="post" action="/admin.php/Home/Index/qiugou">
    ...
    <!-- <td align="right"><a href="/admin.php/Home/Index/tgbz_list/cz/0/">未匹配</a> <a href="/admin.php/Home/Index/tgbz_list/cz/1/">已匹配</a> <a onClick="javascript:if(!confirm('1-1自动匹配前请先备份备据,未备份请点取消,点确定自动匹配所有订单!'))  return  false; "  href="/admin.php/Home/Index/zdpp_cl">所有订单自己动匹配</a> </td> -->
  </tr>
  <tr>
    ...
    <table class="tablelist">
		...
		<td><a href="/admin.php/Home/Index/qiugoudel/id/<?php echo ($v["id"]); ?>" class="tablelink">删除</a></td>
