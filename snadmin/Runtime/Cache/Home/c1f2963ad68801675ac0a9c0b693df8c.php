...
<table width="90%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC" class="tablebg" id="table1">
  <tr>
   <!--  <td width="157" bgcolor="#FFFFFF" class="tbkey" >分类：</td>
    <td width="301" bgcolor="#FFFFFF" class="tbval" ><select name="IF_type" id="IF_type">
      ...
      <option value="whatwk">什么是挖矿</option>
      <option value="whatsl">什么是算力</option>
      <option value="whatlkb">有关莱肯币转出</option>
            </select></td> -->
    </tr>
 ...
 <tr>
    <td bgcolor="#FFFFFF" class="tbkey" >英文标题：</td>
    <td bgcolor="#FFFFFF" class="tbval"><input name="enIF_theme" type="text" id="IF_theme" size="90" /></td>
 </tr>	
...
<textarea name="encontent" style="width:700px;height:200px;visibility:hidden;"></textarea></td>
    </tr>
  <!--微信填寫-->
</table>
<!--基本信息結束-->
