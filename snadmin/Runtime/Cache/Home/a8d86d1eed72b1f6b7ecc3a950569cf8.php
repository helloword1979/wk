...
<div>总投诉条数：<?php echo ($count); ?>
    ...
    <table class="tablelist">
      ...
      <tbody>
		...
		<td><a href="/admin.php/Home/Index/tscl/id/<?php echo ($v["id"]); ?>" class="tablelink">冻结账号</a>|<a href="/admin.php/Home/Index/tsdel/id/<?php echo ($v["id"]); ?>" class="tablelink">删除</a></td>
