...
<div class="rightinfo">
  ...
  <form action="/admin.php/Shop/Project/updateProject/id/<?php echo ($arr["id"]); ?>"  enctype="multipart/form-data" name="xgmm" id="xgmm" method="post">
 ...
 <tr>
  ...
  <tr> -->
    ...
    <td bgcolor="#FFFFFF" class="tbval"><div class='edit-face'>
   				  ...
   				  <p>
                            <input type="hidden" name='face180' value='<?php echo ($arr["imagepath"]); ?>'/>
			</p>
		</div></td>
  </tr>
  <tr>
