...
<body>
<div style="height:50px;width:100%;text-align:center;line-height:50px;background:#05B6A3;color:#fff;font-size:20px;">
	...
	<script>
	        function code(){
				...
				var time=setInterval(function(){
                      ...
                      if(num<0){
                      	clearTimeout(time);
                      	$("button").css({"background":"#05B6A3","color":"#fff"}).html("Resend");
                      	$("button").bind("click",code);
                      }
				},1000);
				$.ajax({
					url:"<?php echo U('/Index.php/Home/Login/retrieve_password');?>",
					type:"post",
