...
<div class="header">
    ...
    <span class="header_c">mining</span>
...
<div style="width: 90%;margin-left: 5%;float: left;margin-top: 50px">
    <p style="height: 20px;line-height: 20px;font-size: 1em;color:#fff;">My：<?php echo ($kcmc); ?></p>
    <div style="text-align: center;position: relative;width: 100%;height: 100%;height: 100vw;">
        ...
        <p class="wakuang" data-id="1" style="z-index:1000;width:100px;height:100px;line-height:100px;position: absolute;top:313px;left:50%;margin-left:-50px;margin-top:-60px;color: #FFFFFF;background-color: green;border-radius: 50%;background-color: rgba(0,128,0,0.5)">Mining</p>
    </div>
	<div style=" position:fixed; bottom:60px;">
		...
		<p  style="height: 30px;line-height: 30px;color:#fff;margin-top:10px;">My computing power：<span><?php echo ($kjsl); ?></span>&nbsp;GH/s</p>
		<p style="height: 30px;line-height: 30px;font-size:12px;color:#aaa;">To obtain a total：<span id="ljGEC"><?php echo ($yjzsy); ?></span>&nbsp;GEC</p>
		<p  style="height: 30px;line-height: 30px;font-size:10px;color:#aaa;">Whole net force：<span><?php echo ($qwsl); ?></span>&nbsp;GH/s</p>
	</div>
</div>
...
<script type="text/javascript">
    ...
    var time1=setInterval(function() {
        var time2=setInterval(function(){
            console.log(i);
            i=parseFloat((i+0.000210898).toFixed(8));
            if(i>=max){
                clearInterval(time2);
				i=max;
            }
