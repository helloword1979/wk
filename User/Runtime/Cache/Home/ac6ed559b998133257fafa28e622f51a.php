...
<body style="background-color: #eee">
	...
	<form action="<?php echo U('/Index.php/Home/Login/uppwd');?>" id="myform" method="post"style="margin-top:20px">
		...
		<button type="submit" id="submit"style="margin-left: 5%;width: 90%;height: 2.5em;line-height: 2.5em;font-size: 1em;letter-spacing: 1px;text-align: center;color: #fff;border-radius: 5px;-webkit-border-radius: 5px;-moz-border-radius: 5px;background-color: #05B6A3;border: 0">密码找回</button>
	</form>
</body>
<script>
     function code(){
