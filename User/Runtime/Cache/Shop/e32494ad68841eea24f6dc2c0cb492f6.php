			...
			<?php if(is_array($list)): foreach($list as $key=>$v): ?><li style="position:relative;">
				...
				<div style="width:60%;display:inline-block;">
					...
					<P>运行周期：<?php echo ($v["yxzq"]); ?>小时</P>
					 ...
					 <a href="/Index.php//Shop/index/jiaoyi?id=<?php echo ($v["id"]); ?>"style="color: #fff;margin-top: 0px;display:block;position:absolute;right:10px;top:50%;margin-top: -15px;font-size: 16px;padding: 5px;background-color: #05B6A3;border: 0px solid #fff;border-radius: 4px;">购买</a>
