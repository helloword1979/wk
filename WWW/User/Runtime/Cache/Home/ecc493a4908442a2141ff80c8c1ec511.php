...
<body class="page-mobile ">
        ...
        <ul class="com-columns span2">
		 <li class="comc-item">
                <div class="com-formbox" style="overflow:hidden;display:block;">
							<a href="/Index.php/Home/Login/login/" style="float:left;width:50%;text-align:center;line-height:30px;color:#05B6A3;;">中文</a>
							<a href="/Index.php/Home/Login/enlogin/" style="float:right;width:50%;text-align:center;line-height:30px;color:#333;">English</a>
                </div>
            </li>
            <li class="comc-item">
            ...
            <li class="comc-item">
                <div class="com-formbox">
                    ...
                    <span class="formbox-bd"><input  type="password" id="password" name="password" onkeyup="this.value=this.value.replace(/ /g,'')" maxlength="20" class="input-txt" placeholder="请输入登录密码" /></span>
                </div>
            </li>
        </ul>
	...
	<button id="mysubmit" style="background-color:#05B6A3;width:100%;height:47px;line-height:47px;color:#fff;border:0px;border-radius:5px;font-size:16px;">登录</button>
   ...
   <ul>
	...
	<div class="def-p txtr">
        <a href="http://www.appmaker.cc/IADeviceJudge/iosOrAndroid?appoid=0f6904ba9d794d6c96bf3a983197810f
" class="fz13 link" id="findPwd_btn">APP下载</a>
    </div>
	</li>
    <!-- 忘记密码 S -->
	<li>
...
<script type="text/javascript" src="/reg/s/login.js"></script>
        ...
        $.ajax({
			...
			console.log(data);
                if(data.status==1){
                    ...
                    location.href="/index.php/Home/Myuser/ssgh/";
                }else{
                    $.alert(data.msg);
                }
            },error:function(){
