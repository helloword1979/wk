...
<body class="page-mobile ">
    ...
    <div class="login-form def-m mb10">
	 <li class="comc-item">
                <div class="com-formbox" style="overflow:hidden;display:block;">
							...
							<a href="/Index.php/Home/Login/enlogin/" style="float:right;width:50%;text-align:center;line-height:30px;color:#05B6A3;">English</a>
                </div>
            </li>
	...
	<button id="mysubmit" style="background-color:#05B6A3;width:100%;height:47px;line-height:47px;color:#fff;border:0px;border-radius:5px;font-size:16px;">Sign in</button>
...
<script src="/Public/web/js/jquery-weui.min.en.js"></script>
