...
<body>
   ...
   <ul style="width:90%;padding-top:15%;margin-left:5%">
    ...
    <p style="text-align:center;width:100%;height:40px;line-height:40px;padding-top:36px;">新注册会员请联系公会会长免费领取矿机</p>
</div>
...
<form id="form1" name="form1" method="post" action="/Index.php/Home/Myuser/ghglto"style="width:90%;margin-left:5%">
         <span style="text-align:center;width:30%;display:inline-block;">公会名称:</span>       
             <input style="width:65%;border:0px;height:30px;line-height:30px;border-radius:5px;" type="text" value="<?php echo ($return["ghname"]); ?>" name="ghname" placeholder="请输入公会名称" disabled="disabled" />
         <span style="text-align:center;width:30%;display:inline-block;vertical-align:top;margin-top:10px">公会宣言:</span>
             <textarea rows="5" cols="8" style="width:65%;border:0px;border-radius:5px;margin-top:10px;" name="ghxy"  placeholder="请输入公会宣言"  disabled="disabled" ><?php echo ($return["ghxy"]); ?></textarea>
         <span style="text-align:center;width:30%;display:inline-block;vertical-align:top;margin-top:10px">公会QQ群&nbsp;&nbsp;</span>
             <input style="width:65%;border:0px;height:30px;line-height:30px;border-radius:5px;margin-top:10px" type="text" value="<?php echo ($return["ghqq"]); ?>" name="ghqq" placeholder="请输入公会QQ群"  disabled="disabled" />
         <span style="text-align:center;width:30%;display:inline-block;vertical-align:top;margin-top:10px">会长微信&nbsp;&nbsp;</span>
             <input style="width:65%;border:0px;height:30px;line-height:30px;border-radius:5px;margin-top:10px" type="text" value="<?php echo ($return["hzvx"]); ?>" name="hzvx" placeholder="请输入会长微信" disabled="disabled" />
         <span style="text-align:center;width:30%;display:inline-block;vertical-align:top;margin-top:10px">会长QQ&nbsp;&nbsp;</span>
             <input style="width:65%;border:0px;height:30px;line-height:30px;border-radius:5px;margin-top:10px" type="text" value="<?php echo ($return["hzqq"]); ?>" name="hzqq" placeholder="请输入会长QQ" disabled="disabled" />
         <span style="text-align:center;width:30%;display:inline-block;vertical-align:top;margin-top:10px">会长手机&nbsp;&nbsp;</span>
             <input style="width:65%;border:0px;height:30px;line-height:30px;border-radius:5px;margin-top:10px" type="text" value="<?php echo ($return["hzphone"]); ?>" name="hzphone" placeholder="请输入会长手机"  disabled="disabled"  />
