...
<script type="text/javascript" src='/Public/Uploadify/jquery.uploadify.min.js'></script>
 <script type='text/javascript'>
        ...
        var PUBLIC = '/Public';
        var uploadUrl = "http://3a.zzjunyi.cn/admin.php/Shop/Common/uploadFace";
...
<label></label>
<div class="rightinfo">
  <form action="/admin.php/Shop/Project/saveProject"  enctype="multipart/form-data" name="xgmm" id="xgmm" method="post">
